...
class Configs(object):
    def __init__(self):
        ...
        parser.add_argument('--save_model', type='bool', default=False, help='save model ckpt or not')
        ...
        parser.add_argument('--fine_grained', type='bool', default=False, help='6 q classes or 34')


        # @ ----------training ------
        parser.add_argument('--max_epoch', type=int, default=200, help='max epoch number')
        parser.add_argument('--num_steps', type=int, default=99000, help='max steps num')

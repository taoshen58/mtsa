...
class ModelMTSA(ModelTemplate):
    def __init__(self, token_emb_mat, glove_emb_mat, tds, cds, tl, output_cls_num, scope):
        super(ModelMTSA, self).__init__(token_emb_mat, glove_emb_mat, tds, cds, tl, output_cls_num, scope)
    ...
    def build_network(self):
        ...
        seq_rep = multi_mask_tensorized_self_attn(
            ...
            attn_keep_prob=cfg.attn_dropout, dense_keep_prob=cfg.dropout, wd=cfg.wd,

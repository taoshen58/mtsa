...
class Configs(object):
    def __init__(self):
        ...
        parser.add_argument('--eval_period', type=int, default=500, help='evaluation period')    # fixme
        ...
        parser.add_argument('--model_dir_prefix', type=str, default='', help='model folder name prefix')
        ...
        parser.add_argument('--attn_dropout', type=float, default=0.8, help='attn dropout keep prob')
